...
- Реализованный функционал:
  ...
  - При клике на кнопку рассчитать цену по моим размерам или заказать звонок появляется модальное окно с формой отправки сообщения на почту". На устрайствах размером < 768px появляется адаптивное бургер-меню.
...
- Реализованный функционал:
  ...
  - В зависимости от исхода отправки сообщения(успешно/неуспешно) пользователь будет перенаправлен на соответствующую страницу.
...
### При возникновении ошибки запроса JSON файла с удаленного сервера,сайт не ломается,а пользователь видит красиво оформленный блок кода
...
- SCSS-модули с использованием переменных, миксинов и вложенности.
...
- Адаптивная и доступная (a11y) верстка.
