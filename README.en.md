## **Project: Website for a Shower Partition installations company**
...
Below are the main pages of the project. All pages are designed in the same style, adapted for different devices and optimized for fast loading.
...
<p>
  ...
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937160/burgerOnAbout_rnnmzo.png" alt="About Us block on mobile" width = '48%' />
</p>
<p>
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937159/burgerMenu_pp35hg.png" alt="Burger menu with closed navigation on mobile" width = '48%' />
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937159/burgerMenu1_un8hzb.png" alt="Burger menu with open navigation on mobile" width = '48%' />
</p>
...
- Implemented functionality:
  ...
  - Infinite carousel with product captions and thumbnails.
...
<p>
  ...
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937338/productsItem2_ubxhnm.png" alt="Open carousel in 'Products' block on mobile screen" width = '48%' />
</p>

---

- ➤ Block 'Examples of interior shower partitions'
...
<p>
  ...
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937161/examplesItem2_k5ihbv.png" alt="Open carousel in 'Examples of Interior Shower Partitions' block" width = '48%' />
</p>
...
<p>
  ...
  <img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937162/portfolioPageItem2_y4mx43.png" alt="Open carousel on the 'Portfolio' page" width = '48%' />
</p>

---

### 🖥️ "Useful Information" page
...
<p>
	<img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937160/articlePageItem1_faytrz.png" alt="Contacts Widget" width = '48%' />
	<img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937158/articlePageItem2_lzaaez.png" alt="callBackForm when clicking on the 'book a callback' button in the Contacts Widget" width = '48%' />
</p>
...
### 🖥️ Page 'Successfully sending a message to a company email'

<img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937162/successfulPage_oedcfo.png" alt="The ‘Successful Posting Page’ on the big screen"/>

---

### 🖥️ “Unsuccessful Send Message to Company Mail” page

<img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937162/unsuccessfulPage_cafq2d.png" alt="Page ‘Unsuccessful Send Message’ on large screen"/>

---

### 🖥️ Page “404”

<img src="https://res.cloudinary.com/dkcilxezg/image/upload/v1745937158/404_aduymo.png" alt="Page 404 on large screen"/>
...
- Basic analytics connected to track site events.

---

## ✨ Project functionality

- Switching products by category using tab buttons.

- Infinite carousel and slider with product thumbnails and captions.
...
- Semantic HTML5 markup and accessibility:
  ...
  - Closing modal windows with the Esc key.

- Breadcrumbs for easy site navigation.

- Communication widgets:

  - On all devices: call, callback, quick jump to key sections.

  - For <768px: Telegram and call.

- Full form validation (mandatory fields, email, phone).
...
| Metric            | Value (Mobile) |
| ----------------- | -------------- |
| ⏱️ Load Speed     | 95-100 points  |
| 🔍 SEO            | 100/100        |
| ♿ Accessibility  | 96-100/100     |
| 🧪 Best Practices | 100/100        |

Tested via Google Lighthouse and PageSpeed Insights
