	...
	"@graph": [
		{
			...
			itemListElement: [
				{
					"@type": "Product",
					name: "Шторка в ванную",
					description:
						"Стеклянная шторка в ванную — компактное решение для душевых, подходит для ограниченного пространства.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-1",
					aggregateRating: {
				...
				},
				{
					...
					description:
						"Стеклянная перегородка для душа — минималистичное решение для зонирования ванной комнаты.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-2",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					...
					name: "Дверь в нишу",
					description:
						"Дверь в нишу — практичное решение для установки душа в ограниченном пространстве.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-3",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					...
					name: "Душевая в нишу",
					description:
						"Компактная душевая конструкция, устанавливаемая в нишу — удобна и эстетична.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-4",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Угловая душевая",
					description:
						"Угловая душевая кабина — оптимальное решение для экономии пространства.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-5",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Трапециевидная душевая",
					description:
						"Трапециевидная форма душевой — стильная альтернатива стандартным решениям.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-6",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					...
					name: "Душевая кабина",
					description:
						"Полноценная душевая кабина — включает ограждение и двери для удобства и комфорта.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-showers-7",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
			...
			itemListElement: [
				{
					...
					description:
						"Прозрачное стекло — классический выбор для душевых конструкций.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-glasses-1",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					...
					description:
						"Осветленное стекло без зелёного оттенка — более чистый внешний вид.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-glasses-2",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Матовое стекло (Обычное,бронзовое,графит)",
					description:
						"Матовое стекло в трёх оттенках — для уединённости и стиля.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-glasses-3",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Тонированное стекло с оттенком бронзы",
					description:
						"Тонированное стекло с бронзовым оттенком — добавляет теплоты интерьеру.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-glasses-4",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Тонированное cтекло с оттенком графита",
					description:
						"Тонированное стекло с графитовым оттенком — элегантный и современный вариант.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-glasses-5",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
		...
		{
			"@type": "ItemList",
			name: "Цвета фурнитуры",
			itemListElement: [
				{
					"@type": "Product",
					name: "Черный",
					description: "Фурнитура чёрного цвета — строго и современно.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-furniture-1",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					"@type": "Product",
					name: "Золото",
					description: "Золотая фурнитура — акцент на роскошь и стиль.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-furniture-2",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					"@type": "Product",
					name: "Бронза",
					description: "Фурнитура в цвете бронзы — тепло и уют в деталях.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-furniture-3",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				},
				{
					...
					name: "Никель",
					description:
						"Никелированная фурнитура — нейтральная и универсальная.",
					image:
				...
				},
				{
					"@type": "Product",
					name: "Хром",
					description: "Хромированная фурнитура — блестящий и надёжный акцент.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-furniture-4",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
		...
		{
			"@type": "ItemList",
			name: "Типы открывания дверей",
			itemListElement: [
				{
					"@type": "Product",
					name: "Распашной тип открывания дверей",
					description: "Двери с распашным механизмом — простота и надёжность.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-typeOpening-1",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
				...
				{
					"@type": "Product",
					name: "Откатной тип открывания дверей",
					description:
						"Откатные двери — экономят место и удобны в использовании.",
					image:
					...
					url: "https://w0x3r.github.io/Shower-Partitions#galery-typeOpening-2",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "BYN",
...
export default productsSectionSchema
