const reasonsToContactData = [
	{
		...
		text: `До 30 суток — таков срок изготовления стеклянного душевого ограждения.`,
	},
	{
		id: "reasonsToContact_1",
		text: `До 3 дней — столько времени нам нужно для доставки и монтажа перегородки.`,
	},
	{
		id: "reasonsToContact_2",
		text: `18 месяцев — это срок гарантии на материалы и профиль, так как мы уверены в их высоком качестве.`,
	},
	{
