const reasonsListData = [
	...
	{
		id: "reasons_3",
		text: `Срок изготовления перегородок — до 30 суток.`,
	},
	{
		id: "reasons_4",
		text: `Время доставки и сборки — в течение 3 дней.`,
	},
	{
		id: "reasons_5",
		text: `Гарантия — 18 месяцев на остекление, фурнитуру и прочие материалы.`,
	},
	{
		id: "reasons_6",
