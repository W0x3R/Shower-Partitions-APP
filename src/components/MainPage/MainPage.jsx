	...
	return (
		<>
			<Helmet>
				...
				<meta
					property="og:title"
					content="Душевые перегородки по индивидуальным размерам на заказ в
					Гомеле от DZ System"
				/>
				<meta
				...
				<meta
					property="og:image"
					content="https://W0x3R.github.io/Shower-Partitions-APP/og-image.jpg"
				/>
				...
				<meta
					name="twitter:title"
					content="Душевые перегородки на заказ в Гомеле"
				/>
				<meta
